...
function inizializzazione() {
    ...
    comboRegione.style.display = "block";
    comboProvincia.style.display = "none";
    comboComune.style.display = "none";
...
function getProvincia(idRegione) {
    ...
    selProvincia.style.display = "block";
}
...
function visualizzaScelte(){
    ...
    var selProvincia = document.getElementById("provincia");
    var selComune = document.getElementById("comune");
    let scelte = 'Hai scelto: ' + selRegione.options[selRegione.selectedIndex].indexText + ' - ' + selProvincia.value + ' - ' +   selComune.value;
    console.log(scelte);
